...
<head>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Habilitar el botón de envío cuando los campos estén completos
            document.querySelector('form').addEventListener('input', function() {
                if (cardNumberInput.value.length === 19 && documentTypeInput.value.length === 8 && claveWebCheckbox.checked) {
